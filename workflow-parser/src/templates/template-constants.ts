...
export const BOOLEAN_DEFINITION = "boolean-definition.js";
export const BOOLEAN_DEFINITION_PROPERTIES = "boolean-definition-properties";
export const CLOSE_EXPRESSION = "}}";
export const CONSTANT = "constant";
export const CONTEXT = "context.js";
export const DEFINITION = "definition.js";
...
export const ITEM_TYPE = "item-type.js";
export const LOOSE_KEY_TYPE = "loose-key-type.js";
export const LOOSE_VALUE_TYPE = "loose-value-type.js";
export const MAX_CONSTANT = "MAX";
export const MAPPING = "mapping";
export const MAPPING_DEFINITION = "mapping-definition.js";
